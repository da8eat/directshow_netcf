...
using DirectShowNETCF.Camera.AMCameraEx;
...
namespace AMCameraExControl
{
    ...
    public partial class AMCameraExControl : UserControl
    {
        ...
        private AMResultEx _result = AMResultEx.OK;
        ...
        public bool init()
        {
            ...
            _result = _camera.init(RotationType.Auto);
        ...
        public bool Start()
        {
            ...
            return _camera.run(this.Handle);
        }
        ...
        {
            if (_result != DirectShowNETCF.Camera.AMCameraEx.AMResultEx.OK)
            {
                return null;
            }
